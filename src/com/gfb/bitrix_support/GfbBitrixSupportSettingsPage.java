 ...
 */
public class GfbBitrixSupportSettingsPage implements Configurable {
    private static final Logger logger = Logger.getInstance("#GfbBitrixSupportSettingsPage");
    ...
    public GfbBitrixSupportSettingsPage(Project project) {
    ...
    public JComponent createComponent() {
        logger.warn("Setting window opened");
